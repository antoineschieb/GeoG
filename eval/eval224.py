...
if __name__ == "__main__":
    ...
    small_ds = PartitionedDataset(f"{DATADIR}v3_eval", 10, (224, 224, 3), offset=(0, 0), ohe=ds.ohe)
    # model
    ...
    model.load_state_dict(torch.load(f"{ROOTDIR}training/saved_models/ResNet18/ccub_BEST/latest.pth"))
    model.to(device)
    model.eval()
